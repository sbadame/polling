...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Poll.date_expire'
        db.add_column('polls_poll', 'date_expire', self.gf('django.db.models.fields.DateTimeField')(null=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Poll.date_expire'
        db.delete_column('polls_poll', 'date_expire')
